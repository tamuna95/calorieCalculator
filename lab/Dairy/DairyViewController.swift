...
class DairyViewController: UIViewController {
    ...
    @IBOutlet weak var DairyCollectionView :UICollectionView!
    var dairyItems = ["First Cell","Second Cell","Third Cell","Fourth Cell","Five Cell","Six Cell","Seven Cell","Eight Cell", "First Cell","Second Cell","Third Cell","Fourth Cell","Five Cell","Six Cell","Seven Cell","Eight Cell"]
    
    var flowLayout: UICollectionViewFlowLayout {
        return DairyCollectionView.collectionViewLayout as! UICollectionViewFlowLayout
    }
...
extension DairyViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let dairycell = collectionView.dequeueReusableCell(withReuseIdentifier: "DairyCell", for: indexPath) as! DairyCollectionViewCell
        dairycell.DairyLabel.text = dairyItems[indexPath.row]
        return dairycell
    }
}
